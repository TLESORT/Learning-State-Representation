...
local function topActivation(net,imgs,level)
	for i=1, nbIm do
		...
		filename=paths.home.."/Bureau/Resultat_non_supervise/04_10/image"..i..".jpg"
...
local net = torch.load('./Log/04-10-newReward-oneList/Everything/Save04-10-newReward-oneList.t7'):double()
print('net\n' .. net:__tostring());
...
--out=topActivation(net,Data_test.images,17)
----------color-------------
